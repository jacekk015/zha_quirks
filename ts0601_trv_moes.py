...
class MoesValveDetect(CustomTuyaOnOff):
    ...
    def map_attribute(self, attribute, value):
        """Map standardized attribute value to dict of manufacturer values."""
        if attribute == "on_off":
            return {MOES_VALVE_DETECT_ATTR: value}
...
class MoesAwayTemp(LocalDataCluster, AnalogOutput):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._update_attribute(
            self.attributes_by_name["description"].id, "Away temperature"
        )
        self._update_attribute(self.attributes_by_name["max_present_value"].id, 35)
        self._update_attribute(self.attributes_by_name["min_present_value"].id, 5)
        self._update_attribute(self.attributes_by_name["resolution"].id, 1)
...
class MoesAwayDays(LocalDataCluster, AnalogOutput):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._update_attribute(self.attributes_by_name["description"].id, "Away days")
        self._update_attribute(self.attributes_by_name["max_present_value"].id, 9999)
